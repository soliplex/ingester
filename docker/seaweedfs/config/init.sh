...
echo 's3.configure -access_key=soliplex -secret_key=soliplex -user=soliplex -buckets=soliplex-input,soliplex-artifacts,soliplex-lancedb --actions Read,Write,List,Tagging --apply true' |weed shell -master=seaweedfs:9333
