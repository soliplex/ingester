...
echo "========================================"
echo "Building Soliplex Ingester UI (Docker)"
echo "========================================"
echo ""
echo "This will:"
echo "  1. Install npm dependencies (via Docker)"
...
echo ""
echo "Using: node:lts-alpine Docker image"
echo ""
...
# Build the UI (includes static-filenames post-processor) using Docker
